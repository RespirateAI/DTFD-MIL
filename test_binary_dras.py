...
def main():
    ...
    tsave_dict = torch.load(
        os.path.join(params.log_dir, "best_model_lung_random_binary_ct_for_resnet.pth")
    )
...
def test_attention_DTFD_preFeat_MultipleMean(
    ...
    # np.save("./Attention/attention_weights_ct_for_resnet1.npy", numpy_data_dict)

    # # Write name, ground truth, and prediction to a csv
    # with open("predictions2.csv", "w") as f:
    #     f.write("Name,Ground Truth,Dras_Prediction\n")
