...
loaded_numpy_data_dict = np.load(
    "./Attention/attention_weights_ct_for_resnet1.npy", allow_pickle=True
).item()
...
for key in keys:
    if key == "Lung_Dx-G0052&02-05-2011-PETNEW03CBMWholebodyFirstHead_Adult-09494&14":
        print("Found")
        name = key
...
plt.savefig("attention_heatmap_4.png")
