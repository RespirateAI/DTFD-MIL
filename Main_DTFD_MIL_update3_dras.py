...
def main():
    ...
    save_dir = os.path.join(
        params.log_dir, "best_model_lung_random_binary_ct_for_resnet.pth"
    )
    z = vars(params).copy()
...
def test_attention_DTFD_preFeat_MultipleMean(
    ...
    data = LungDataset(
        "/media/ravindu/SSD-PLU3/Lung_CT_Dataset/Lung-PET-CT-Dx-NBIA-Manifest-122220/DrasNew/DrasCLR/embeddings_ct_for_resnet/test"
    )
...
def train_attention_preFeature_DTFD(
    ...
    data = LungDataset(
        "/media/ravindu/SSD-PLU3/Lung_CT_Dataset/Lung-PET-CT-Dx-NBIA-Manifest-122220/DrasNew/DrasCLR/embeddings_ct_for_resnet/train"
    )
    dataloader = DataLoader(data, params.batch_size, collate_fn=custom_collate)
